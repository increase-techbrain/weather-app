  ...
  return (
    <div className="min-h-screen bg-sky-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div className="">
          <p className="px-4 py-2 rounded-full text-sm font-medium shadow bg-white inline-block">
            Live Weather Updates
          </p>

          <h1 className=" text-5xl md:text-6xl font-extrabold leading-tight mt-6 text-[#132c63]">
            {" "}
            Weather Forecasts
          </h1>
          ...
          <p className="text-gray-600 mt-6 text-lg leading-relaxed">
            {" "}
            Get accurate real-time weather forecasts from any city around the
            world with beautiful visuals and instant updates
          </p>

          <div className="flex gap-4 mt-6">
            <button className="bg-blue-900 text-white  rounded  hover:scale-105 duration-300 shadow-lg px-3 py-3">
              Explore Weather
            </button>

            <button className="bg-blue-100 text-blue-900 rounded shadow hover:scale-105 duration-300 px-3 py-1">
              Learn More
            </button>
          </div>
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="flex flex-col items-center mt-10">
                  ...
                  <h1 className="text-4xl font-bold mt-2 text-blue-950">
                    {weather.name}
                  </h1>
